...
describe("Debt solver", function() {
  ...
  it("solves solves easy case", function() {
    var p11 = {paid: 0, share: 5.55, person: {id: 1}, expense: {id: 1}};
    var p21 = {paid: 11.11, share: 5.56, person: {id: 2}, expense: {id: 1}};

    var debts = solveDebts([p11, p21]);

    expect(debts.length).toBe(1);
    expect(debts[0]).toEqual({debtor: {id: 1}, creditor: {id: 2}, amount: 5.55});
  });

  it("returns empty array if no debts", function() {
    var p11 = {paid: 5, share: 5, person: {id: 1}, expense: {id: 1}};
    var p21 = {paid: 5, share: 5, person: {id: 2}, expense: {id: 1}};
  ...
  it("computes debts from participations when there are two free variables", function() {
  ...
  it("computes debts in random balance sheets", function() {
  ...
  it("throws error if system is not balanced", function() {
    // Sum of shares = 11.12, sum of payments = 11.11
    var p11 = {paid: 0, share: 5.56, person: {id: 1}, expense: {id: 1}};
    var p21 = {paid: 11.11, share: 5.56, person: {id: 2}, expense: {id: 1}};

    expect(function() {
      solveDebts([p11, p21]);
    }).toThrowError("Debt system is not balanced");
  });
